...
dataset = HDF5Dataset(glob.glob("/data/processed_data/processed_train_*.hdf5"), True, True, True, True)
...
lr_scheduler = optim.lr_scheduler.CosineAnnealingLR(optimiser, T_max=10, eta_min=8e-5)
